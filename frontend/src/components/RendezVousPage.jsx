...
// // // // // //   // État du Modal Radar Étudiant & Compétences dynamiques
// // // // // //   const [modalOpen, setModalOpen] = useState(false);
// // // // // //   const [modalLoading, setModalLoading] = useState(false);
// // // // // //   const [selectedEtudiantInfo, setSelectedEtudiantInfo] = useState(null);
...
// // // // // //   // Construction de la matrice Étudiants x Chefs
// // // // // //   const matrixChefs = useMemo(() => {
// // // // // //     const chefs = new Set(filteredRdv.map((r) => r.chef_de_projet).filter(Boolean));
// // // // // //     return Array.from(chefs).sort();
// // // // // //   }, [filteredRdv]);
...
// // // // // //   // Ouverture du Popup Radar Dynamique
// // // // // //   const handleOpenStudentRadar = async (etudiant_id, etudiantName, email) => {
// // // // // //     if (!etudiant_id) return;
// // // // // //     setSelectedEtudiantInfo({ id: etudiant_id, nom: etudiantName, email });
// // // // // //     setModalOpen(true);
...
// // // // // //   // Données du graphique Radar générées dynamiquement
// // // // // //   const radarChartData = useMemo(() => {
...
// // // // //         grid: { color: 'rgba(148, 163, 184, 0.14)' },
// // // // //         angleLines: { color: 'rgba(148, 163, 184, 0.14)' },
// // // // //         pointLabels: { color: '#f1f5f9', font: { size: 12, weight: '600' } },
// // // // //       },
// // // // //     },
// // // // //     plugins: {
// // // // //       legend: { display: false },
...
// // // // //       <style>{`
// // // // //         :root {
// // // // //           /* --- Fond & panneaux : bleu-nuit neutre, sobre --- */
// // // // //           --canvas-bg: #0a0e1a;
// // // // //           --panel-bg: rgba(15, 20, 33, 0.92);
// // // // //           --panel-solid: #10141f;
// // // // //           --panel-raised: #141b2c;
...
// // // // //           /* --- Palette d'accents harmonisée : un bleu principal + couleurs sémantiques --- */
// // // // //           --accent-cyan: #2563eb;              /* bleu principal (identité, mise en avant) */
// // // // //           --accent-cyan-soft: rgba(37, 99, 235, 0.15);
// // // // //           --accent-teal: #0e7490;              /* bleu-pétrole secondaire (compétences / documents) */
// // // // //           --accent-teal-soft: rgba(14, 116, 144, 0.15);
// // // // //           --accent-indigo: #4f46e5;            /* indigo profond (badges, entêtes matrice) */
// // // // //           --accent-indigo-soft: rgba(79, 70, 229, 0.15);
// // // // //           --accent-amber: #d97706;             /* avertissement / second axe radar */
// // // // //           --accent-amber-soft: rgba(217, 119, 6, 0.15);
// // // // //           --accent-emerald: #059669;           /* succès / validation */
// // // // //           --accent-emerald-soft: rgba(5, 150, 105, 0.15);
// // // // //           --accent-rose: #be123c;              /* réservé (non utilisé en priorité) */
// // // // //           --accent-danger: #dc2626;            /* danger / suppression */
// // // // //           --accent-danger-soft: rgba(220, 38, 38, 0.15);

// // // // //           /* --- Accent "vue Chef" : vert sobre pour distinguer sans dénaturer --- */
// // // // //           --accent-chef: #16a34a;
// // // // //         }
...
// // // // //           color: var(--text-primary);
// // // // //           background:
// // // // //             radial-gradient(1000px 480px at 5% -5%, rgba(79, 70, 229, 0.07), transparent 60%),
// // // // //             radial-gradient(900px 480px at 95% 0%, rgba(37, 99, 235, 0.07), transparent 55%),
// // // // //             var(--canvas-bg);
// // // // //           min-height: calc(100vh - 60px);
// // // // //           font-size: 1rem;
// // // // //         }
...
// // // // //         .generator-box {
// // // // //           background:
// // // // //             radial-gradient(600px 220px at 0% 0%, rgba(79, 70, 229, 0.14), transparent 60%),
// // // // //             radial-gradient(600px 220px at 100% 100%, rgba(37, 99, 235, 0.10), transparent 60%),
// // // // //             var(--panel-raised);
// // // // //           border: 1px solid var(--border-strong);
// // // // //           border-radius: 14px;
// // // // //         }
...
// // // // //           background: linear-gradient(180deg, rgba(79, 70, 229, 0.16) 0%, #0e1320 100%) !important;
// // // // //           border-bottom: 2px solid var(--accent-indigo) !important;
// // // // //           border-left: 1px solid var(--border-subtle);
// // // // //         }
// // // // //         .matrix-chef-abbr {
...
// // // // //           padding: 1.25rem 1.5rem;
// // // // //           background:
// // // // //             radial-gradient(600px 220px at 15% 0%, rgba(79, 70, 229, 0.22), transparent 60%),
// // // // //             radial-gradient(600px 220px at 100% 0%, rgba(37, 99, 235, 0.16), transparent 60%),
// // // // //             var(--panel-raised);
// // // // //           border-bottom: 1px solid var(--border-subtle);
// // // // //         }
// // // // //         .radar-modal-close {
...
// // // // //         .radar-stat-dot { width: 8px; height: 8px; border-radius: 50%; }
// // // // //         .radar-stat-cyan .radar-stat-dot { background: var(--accent-cyan); box-shadow: 0 0 8px var(--accent-cyan); }
// // // // //         .radar-stat-rose .radar-stat-dot { background: var(--accent-amber); box-shadow: 0 0 8px var(--accent-amber); }
// // // // //         .radar-stat-label { color: var(--text-muted); font-size: 0.78rem; font-weight: 600; }
// // // // //         .radar-stat-value { color: var(--text-primary); font-weight: 800; font-size: 0.92rem; }
// // // // //         .radar-stat-value small { color: var(--text-muted); font-weight: 500; }
// // // // //         .radar-modal-body {
// // // // //           padding: 1.5rem;
// // // // //           min-height: 400px;
...
// // // // //         /* --- Vue "Chef de projet" : distinction sobre par une teinte verte, sans casser la hiérarchie visuelle --- */
// // // // //         .chef-view .matrix-table tbody tr {
// // // // //           border-bottom: 1px solid rgba(37, 99, 235, 0.35) !important;
// // // // //         }
// // // // //         .chef-view .matrix-cell {
// // // // //           border-left: 1px solid rgba(37, 99, 235, 0.35) !important;
// // // // //         }
// // // // //         .chef-view .matrix-table tbody td.matrix-student-cell {
...
// // // // //         .chef-view .matrix-cell-filled {
// // // // //           background: #101627 !important;
// // // // //           box-shadow: inset 3px 0 0 var(--accent-chef) !important;
// // // // //         }
// // // // //         .chef-view .matrix-slot-date,
// // // // //         .chef-view .matrix-slot-time {
// // // // //           color: var(--accent-chef) !important;
// // // // //         }
// // // // //       `}</style>
...
// // // // //             <div className="d-flex align-items-center gap-2">
// // // // //               <span style={{ fontSize: '1.6rem' }}></span>
// // // // //               <h2 className="fw-bold mb-0" style={{ fontSize: '1.65rem', letterSpacing: '-0.4px', color: 'var(--text-primary)' }}>
// // // // //                 {isAdmin
// // // // //                   ? 'Planning des Rendez-vous '
// // // // //                   : isChef
// // // // //                   ? `Mes Rendez-vous (${chefInfo?.nom || 'Chef de projet'})`
...
// // // // //       {/* Modal Confirmation Réinitialisation Planning */}
// // // // //       <Modal show={showResetModal} onHide={() => setShowResetModal(false)} centered contentClassName="radar-modal-content">
// // // // //         <div className="radar-modal-header" style={{ background: 'rgba(220, 38, 38, 0.15)', borderBottom: '1px solid rgba(220, 38, 38, 0.3)' }}>
// // // // //           <button type="button" className="radar-modal-close" onClick={() => setShowResetModal(false)}>✕</button>
// // // // //           <div className="radar-modal-eyebrow" style={{ color: '#f87171' }}>Zone d'administration</div>
// // // // //           <h4 className="radar-modal-title" style={{ color: '#ffffff', margin: 0 }}>🗑️ Vider le planning des rendez-vous</h4>
// // // // //         </div>
...
// // // //         }
// // // //         .matrix-table tbody tr:nth-child(even) td.matrix-cell-filled {
...
// // // //         }
// // // //         .chef-view .matrix-table tbody tr:nth-child(even) td.matrix-cell-filled {
...
export default function RendezVousPage() {
  ...
  const matrixStudents = useMemo(() => {
    ...
    const sorted = Array.from(map.values()).sort((a, b) => (a.nom || '').localeCompare(b.nom || ''));
    return studentSortDirection === 'desc' ? sorted.reverse() : sorted;
  }, [filteredRdv, studentSortDirection]);
                  ...
                  <tr>
                    <th className="matrix-corner">
                      <button
                        ...
                        onClick={() => setStudentSortDirection((d) => (d === 'asc' ? 'desc' : 'asc'))}
                        title={studentSortDirection === 'asc' ? 'Trier de Z à A' : 'Trier de A à Z'}
                      >
                        <span>Étudiant</span>
                        <span className="sort-toggle-arrow">{studentSortDirection === 'asc' ? '▲' : '▼'}</span>
                      </button>
                    </th>
                    {matrixChefs.map((chef) => (
                      <th key={chef} className="matrix-chef-col" title={chef}>
